...
class EnhancedChatbotService {
  ...
  String _handleAppFeatures({required bool isArabic}) {
    ...
    return '📱 **Saheeh App Features - Complete Guide:**\n\n'
        '🏠 **Home Dashboard:**\n'
        '• Complete daily summary (calories, workouts, water, sleep)\n'
        '• Quick access to all features\n'
        '• AI-powered health insights\n'
        '• Progress and goals tracking\n\n'
        '💊 **Medicine Management:**\n'
        '• Automatic reminders based on schedule\n'
        '• Medicine intake history tracking\n'
        '• Direct pharmacy ordering\n'
        '• Notifications at medication time\n\n'
        '🥗 **Nutrition:**\n'
        '• Log meals with calories and macros\n'
        '• Track daily goals (calories, protein, carbs, fats)\n'
        '• Comprehensive food database\n'
        '• Healthy meal suggestions\n'
        '• Earn XP when logging meals (+10 XP)\n\n'
        '💪 **Fitness:**\n'
        '• Comprehensive workout library (chest, back, legs, shoulders, arms, abs)\n'
        '• Workouts for beginners, intermediate, and advanced\n'
        '• YouTube video links for each workout\n'
        '• Activity and progress tracking\n'
        '• Earn XP when completing workouts (+25 XP)\n\n'
        '💧 **Health Tracking:**\n'
        '• Water intake tracking (daily goal 2000ml)\n'
        '• Sleep hours tracking\n'
        '• Customizable health goals\n'
        '• Earn XP when drinking water (+2 XP) and logging sleep (+5 XP)\n\n'
        '⭐ **XP System:**\n'
        '• Earn XP for daily activities\n'
        '• Automatic level ups\n'
        '• Unlockable achievements\n'
        '• Redeem XP in pharmacy\n\n'
        '🔗 **Additional Features:**\n'
