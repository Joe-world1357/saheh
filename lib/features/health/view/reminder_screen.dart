...
class _ReminderScreenState extends ConsumerState<ReminderScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ---------------- MEDICINE CARDS ----------------
              ...ref.watch(remindersProvider).map((reminder) {
                final dayNames = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
                final currentDay = DateTime.now().weekday % 7;
                final isToday = reminder.daysOfWeek.contains(currentDay);
              ...
              if (ref.watch(remindersProvider).isEmpty)
                const Center(
                  child: Padding(
  ...
  // ---------------- MEDICINE CARD ----------------
  Widget _medicineItem(String name, String subtitle, String time, {VoidCallback? onDelete}) {
    const primary = Color(0xFF20C6B7);
